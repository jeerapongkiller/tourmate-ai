...
class Crew extends DB
{
    ...
    public function insert_data(int $is_approved, string $id_card, string $name, string $telephone, string $address, int $sex, string $birth_date, array $picFile)
    {
        ...
        $query = "INSERT INTO crews (id_card, name, telephone, address, sex, birth_date, pic, is_approved, is_deleted, created_at, updated_at)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, 0, NOW(), NOW())";
    ...
    public function check_id_card(int $id_card, int $crew_id = 0)
    {
        $bind_types = "";
        $params = array();
