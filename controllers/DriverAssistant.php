...
class Driver_Assistant extends DB
{
    ...
    public function insert_data(int $is_approved, string $id_card, string $first_name, string $last_name, string $nickname, string $telephone, string $address, int $sex, string $birth_date, array $picFile)
    {
        // upload pic file
        ...
        $query = "INSERT INTO drivers_assistant (id_card, first_name, last_name, nickname, telephone, address, sex, birth_date, pic, is_approved, is_deleted, created_at, updated_at)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0, NOW(), NOW())";
    ...
    public function update_data(int $is_approved, string $id_card, string $first_name, string $last_name, string $nickname, string $telephone, string $address, int $sex, string $birth_date, array $picFile, int $id)
    {
        // upload pic file
        $picResponse = $this->uploadFile($picFile);
        $countpic = count($picResponse);
        ...
        $query = "UPDATE drivers_assistant SET";
    ...
    public function check_id_card(int $id_card, int $driver_ass_id = 0)
    {
        $bind_types = "";
        $params = array();
        ...
        if ($driver_ass_id != 0) {
            $query .= " AND id != ?";
            $bind_types .= "i";
            array_push($params, $driver_ass_id);
        }
