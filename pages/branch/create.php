                ...
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="./?pages=branch/list">Branches List</a></li>
            ...
            <section class="bs-validation">
                <div class="row">
                    ...
                    <div class="col-md-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                <form id="branch-create-form" name="branch-create-form" method="post" enctype="multipart/form-data">
                                    <div class="row">
