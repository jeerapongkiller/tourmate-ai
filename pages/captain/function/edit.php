...
if (isset($_POST['action']) && $_POST['action'] == "edit" && isset($_POST['captain_id']) && $_POST['captain_id'] > 0) {
    // get value from ajax
    ...
    if ($captain_id > 0) {
        $response = $capObj->update_data($is_approved, $id_card, $name, $telephone, $address, $gender, $birth_date, $picArray, $captain_id);
    }
