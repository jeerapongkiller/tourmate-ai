                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="guide-create-form" name="guide-create-form" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        ?>
                                            <div class="col-md-2 col-12">
                                                <div class="form-group">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input" id="<?php echo $language_item; ?>" name="language[]" value="<?php echo $language['id']; ?>" />
