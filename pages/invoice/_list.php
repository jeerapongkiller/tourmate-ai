                ...
                <div class="modal-content" id="div-modal-detail">
                    ...
                    <div class="modal-body">
                        <form id="receipt-form" name="receipt-form" method="post" enctype="multipart/form-data">
                            <input type="text" id="rec_cover_id" name="cover_id" value="">
                            <input type="text" id="rec_today" name="today" value="<?php echo $today; ?>">
                            <input type="text" id="rec_amount" name="amount" value="">
                            <input type="text" id="rec_id" name="rec_id" value="">
                            <div class="row">
                                <div class="form-group col-md-3 col-12">
                                    <label class="form-label" for="is_approved"></label>
                                    <div class="custom-control custom-checkbox">
                            ...
                            <div class="row">
                                <div class="form-group col-md-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="rec_date_2" name="rec_date" value="" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="form-group col-md-3 col-12" id="div-bank-account-2" hidden>
                                    <div class="form-group">
                                        <?php $banks_acc = $invObj->showbankaccount(); ?>
                                        <label for="bank_account_2">เข้าบัญชี</label>
                                        <select class="form-control select2" id="bank_account_2" name="bank_account">
                                            <option value="">Please choose bank account ... </option>
                                            <?php
                                            foreach ($banks_acc as $bank_acc) {
                                            ?>
                                    ...
                                    <tr class="table-content">
                                        <td width="50%" align="left" colspan="4">
                                            <dl class="row" style="margin-bottom: 0;">
                                                ...
                                                <dd class="col-sm-8" id="agent_name_text_rec"></dd>
                                            </dl>
                                            <dl class="row" style="margin-bottom: 0;">
                                                <dt class="col-sm-4 text-right">
                                                    Address
                                                </dt>
                                                <dd class="col-sm-8" id="agent_address_text_rec"></dd>
                                            </dl>
                                            <dl class="row" style="margin-bottom: 0;">
                                                <dt class="col-sm-4 text-right">
                                                    Tel
                                                </dt>
                                                <dd class="col-sm-8" id="agent_tel_text_rec"></dd>
                                            </dl>
                                            <dl class="row" style="margin-bottom: 0;">
                                                <dt class="col-sm-4 text-right">
                                                    Tax ID.
                                                </dt>
                                                <dd class="col-sm-8" id="agent_tax_text_rec"></dd>
                                            </dl>
                                        </td>
