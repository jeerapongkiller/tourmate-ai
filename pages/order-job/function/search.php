...
if (isset($_POST['action']) && $_POST['action'] == "search") {
    ...
    $first_bo = [];
    $first_trans = [];
    $bookings = $manageObj->showlistboats('job', 0, $get_date, $search_boat, $search_guide, $search_status, $search_agent, $search_product, $search_voucher_no, $refcode, $name, $hotel);
    if (!empty($bookings)) {
    ...
    $first_manage = array();
    $manages = $manageObj->show_manage_boat($get_date, $boat = 'all', $manage);
    if (!empty($manages)) {
