...
$first_bo = [];
$first_trans = [];
$bookings = $manageObj->showlistboats('job', 0, $today, $boat = 'all', $guide = 'all', $status = 'all', $agent = 'all', $product = 'all', '', $refcode = '', $name = '', $hotel = '');
if (!empty($bookings)) {
        ...
        <div class="content-body">
            ...
            <section class="app-user-list">
                ...
                <div class="card">
                    ...
                    <hr class="pb-0 pt-0">
                    <div id="order-jobs-search-table" style="background-color: #FFF;">
                        <!-- Header starts -->
