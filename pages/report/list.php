                        ...
                        <div class="bs-stepper-content p-0">
                            ...
                            <div id="report-overview" class="content">
                                <div class="d-flex justify-content-between">
                                    <button type="button" class="btn btn-info mt-50 ml-1" id="btnCopyOverview"><i data-feather='copy'></i> Copy</button>
                                    <span>
                                    </span>
                                </div>
                                <hr>
                            ...
                            <div id="report-booking" class="content">
                                <div class="d-flex justify-content-between">
                                    <button type="button" class="btn btn-info mt-50 ml-1" id="btnCopyBooking"><i data-feather='copy'></i> Copy</button>
                                    <span>
                                    </span>
                                </div>
                                <hr>
                            ...
                            <div id="report-agent" class="content">
                                <div class="d-flex justify-content-between">
                                    <button type="button" class="btn btn-info mt-50 ml-1" id="btnCopyAgent"><i data-feather='copy'></i> Copy</button>
                                    <span>
                                    </span>
                                </div>
                                <hr>
                            ...
                            <div id="report-programe" class="content">
                                <div class="d-flex justify-content-between">
                                    <button type="button" class="btn btn-info mt-50 ml-1" id="btnCopyPrograme"><i data-feather='copy'></i> Copy</button>
                                    <span>
                                    </span>
                                </div>
                                <hr>
                            ...
                            <div id="report-transfer" class="content">
                                <div class="d-flex justify-content-between">
                                    <button type="button" class="btn btn-info mt-50 ml-1" id="btnCopyTransfer"><i data-feather='copy'></i> Copy</button>
                                    <span>
                                    </span>
                                </div>
                                <hr>
                            ...
                            <div id="report-boat" class="content">
                                <div class="d-flex justify-content-between">
                                    <button type="button" class="btn btn-info mt-50 ml-1" id="btnCopyBoat"><i data-feather='copy'></i> Copy</button>
                                    <span>
                                    </span>
                                </div>
                                <hr>
