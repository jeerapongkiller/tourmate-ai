                    ...
                    <?php if (!empty($bo_id)) {
                        for ($i = 0; $i < count($bo_id); $i++) { ?>
                            <tr>
                                ...
                                <td class="text-center p-25 m-25"><?php echo !empty($tourist_max[$bo_id[$i]]) ? array_sum($tourist_max[$bo_id[$i]]) : 0; ?></td>
                    ...
                    <?php if (!empty($ortran_id)) {
                        foreach ($ortran_id as $x => $val) {
                            ...
                            <tr>
                                ...
                                <td class="text-center p-25 m-25"><?php echo $adult_car; ?></td>
                                <td class="text-center p-25 m-25"><?php echo $child_car; ?></td>
                                <td class="text-center p-25 m-25"><?php echo $infant_car; ?></td>
                                <td class="text-center p-25 m-25"><?php echo $foc_car; ?></td>
                                <td class="text-center p-25 m-25"><?php echo $tourist_car; ?></td>
                            </tr>
                    <?php }
                    } ?>
                </tbody>
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td class="text-center p-25 m-25"><?php echo $adult_boat; ?></td>
                                <td class="text-center p-25 m-25"><?php echo $child_boat; ?></td>
                                <td class="text-center p-25 m-25"><?php echo $infant_boat; ?></td>
                                <td class="text-center p-25 m-25"><?php echo $foc_boat; ?></td>
                                <td class="text-center p-25 m-25"><?php echo $tourist_boat; ?></td>
                            </tr>
                    <?php }
                    } ?>
                </tbody>
